...
window.onload = function(){
	 ...
	 var juego = function(){
	 	/*var letra = ["PHP","Sistema","Operadores","Constantes","Asignacion",
		"Comandos","Condicionales","Logica","Servidor","Variables",
		"Videos","Pdf","Contenido","Software","tecla",
		"Pantalla","Computadora","Internet","Programacion","Linux","Windows",
		"HTML", "CSS", "Base de datos", "Lenguaje", "Codigo", "Diseño", "Satos",
		"salida", "marcador", "lapiz", "traje", "bruja", "mejorando", 
		"Archivos", "Plataforma", "Web", "Proceso", "Interfaz", "ALgoritmo",
		"Funcion", "Clases", "Objeto", "Modulo", "Vistas", "Controlador"
		];*/
		var letra = ["Sistema","Operadores","Constantes","Servidor","Variables"];
		var rnd, largo;
		...
		return {
			...
			generar: function(){
				...
				if (palabra == 'Sistema') {document.getElementById("concepto").innerHTML = "<b>Es un conjunto de partes o elementos organizadas y relacionadas que interactúan entre sí para lograr un objetivo.</b>!";}
				if (palabra == 'Operadores') {document.getElementById("concepto").innerHTML = "<b>Es un símbolo (+, -, *, /, etc) que tiene una función predefinida (suma, resta, multiplicación, etc).</b>!";}
				if (palabra == 'Constantes') {document.getElementById("concepto").innerHTML = "<b>Es un valor que no puede ser alterado/modificado durante la ejecución de un programa, únicamente puede ser leído.</b>!";}
				if (palabra == 'Servidor') {document.getElementById("concepto").innerHTML = "<b>Es una aplicación en ejecución (software) capaz de atender las peticiones de un cliente y devolverle una respuesta en concordancia.</b>!";}
				if (palabra == 'Variables') {document.getElementById("concepto").innerHTML = " <b>Se representan con un signo de dólar seguido por el nombre. El nombre es sensible a minúsculas y mayúsculas.</b>!";}
	...
	/*["Sistema","Operadores","Constantes","Servidor","Variables"]*/
}; // fin del onload;