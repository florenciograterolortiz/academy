        ...
        <div class="row">
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lg">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video introducción PHP</p>
          </div>
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lgw">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video de instalación</p>
          </div>
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lg2">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video de variables</p>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lg4">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video de operadores</p>
          </div>
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lgcondi">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video de condicionales</p>
          </div>
          <div class="col-xs-12 col-md-4">
            <a href="#" title="" data-toggle="modal" data-target=".bs-example-modal-lg3">
              <img src="http://localhost/software/image/videos.png" class="img-responsive img-thumbnail" alt="Responsive image">
            </a>
            <p class="bg-primary">Video de constantes</p>
          </div>
        </div>
      </div>
